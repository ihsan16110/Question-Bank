...
$files = scandir("files/CSE/L1 T1/ME-1181/");
...
for ($a = 2; $a < count($files); $a++)
{
    ...
    <p>
        ...
        <a style="margin: 5px;text-decoration: none; color:red; "href="files/CSE/L1 T1/ME-1181/<?php echo $files[$a]; ?>" download="<?php echo $files[$a]; ?>">
            Download
        </a>
        <a style="margin: 10px;text-decoration: none; color: green;" href="files/CSE/L1 T1/ME-1181/<?php echo $files[$a]; ?>">View</a>
    </p>
    <?php
}