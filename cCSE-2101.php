...
$files = scandir("files/CSE/L2 T1/CSE-2101/");
...
<a style="margin: 5px;text-decoration: none; color:red; "href="files/CSE/L2 T1/CSE-2101/<?php echo $files[$a]; ?>" download="<?php echo $files[$a]; ?>">
            Download
        </a>
        <a style="margin: 10px;text-decoration: none; color: green;" href="files/CSE/L2 T1/CSE-2101/<?php echo $files[$a]; ?>">View</a>
